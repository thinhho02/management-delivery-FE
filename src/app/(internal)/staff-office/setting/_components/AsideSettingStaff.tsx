...
const AsideSettingStaff = () => {
  const pathname = usePathname()
  const sidebarItems = [
    { label: "Hồ sơ", href: "/staff-office/setting" },
    { label: "Thay đổi mật khẩu", href: "/staff-office/setting/change-password" },
  ];
  return (
    <Box
      as="nav"
...
export default AsideSettingStaff