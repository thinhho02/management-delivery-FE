...
import { Box, Flex, Heading, VStack, Icon, Drawer, Button, Portal, HStack, Avatar, Skeleton, Badge } from '@chakra-ui/react'
...
import { usePostInfo } from '../staff-office/_providers/PostInfoProvider'
...
const AsidePost = () => {
    ...
    const items = [
        { value: "1", title: "Quản lý đơn hàng", href: "/staff-office" },
        // { value: "2", title: "Q", href: "/staff-office/chat" },
        // { value: "3", title: "Khiếu nại của khách hàng", href: "/staff-office" },
        { value: "4", title: "Cài đặt tài khoản", href: "/staff-office/setting" },
                    ...
                    <Flex direction={'column'} divideY={'1px'}>
                        ...
                        <VStack align="start" pt={2}>
                            {items.map((item) => {
                                ...
                                const isActive =
                                    (item.href === '/staff-office' && pathname === '/staff-office') || // chỉ sáng khi đúng trang index
                                    (item.href !== '/staff-office' && pathname.startsWith(item.href));
                                return (
                                    <LinkCustom
                                        key={item.value}
                                        href={item.href}
