...
const MapReceiver = memo(({ lngLat, setLngLat, setValue, wardId, setAddressMarker }: Props) => {
    ...
    useEffect(() => {
        ...
        if (!markerRef.current) {
            ...
            marker.on("dragend", async () => {
                ...
                setValue("receiverLngLat", valueLngLat)
        ...
        if (!checkPoint) {
            ...
            setValue("receiverLngLat", '')
        } else {
            setValue("receiverLngLat", lngLat)
        }
    ...
    useEffect(() => {
        ...
        const handleClick = async (e: mapboxgl.MapMouseEvent & mapboxgl.MapEvent) => {
            ...
            // Cập nhật value form
            setLngLat(newValue);
            setValue("receiverLngLat", newValue);
